...
public sealed class User : Entity
{
    ...
    public static User CreateUser(string name, string email, string password, string country, string city,
        string street, string postalCode, string fullAddress)
    {
...
// record = set bloklarını init olarak alır, const bir defa parametre istiyor.