...
### Factories
It is used to create objects with complex and large amounts of business logic. In DDD, not all domain objects are created directly with the new keyword. Some may require specific creation logic.